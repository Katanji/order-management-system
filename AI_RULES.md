...
1.  **Git Operations**: DO NOT perform `git commit` or `git push`. Only the user can do this. Suggest a commit message when a logical unit of work is completed.
2.  **React Version**: Use React 19+.
